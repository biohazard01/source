...
const string strMessageMagic = "corona Signed Message:\n";
...
int64_t GetProofOfWorkReward(int64_t nFees)
{
    ...
    if(pindexBest->nHeight < 20) // CORONA
    {
        nSubsidy = 20000000 * COIN;
    }
    else if(pindexBest->nHeight < 700000) // backup
    {
        nSubsidy = 1 * COIN;
    }
...
// corona: attempt to generate suitable proof-of-stake
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "corona", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "CORONA genesis";
        CTransaction txNew;
        txNew.nTime = 1580546160;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        //// debug print
        assert(block.hashMerkleRoot == uint256("0xb1f2e3d368d73983b317ef8e34cc22cee82447c2dc86098049487fb7a2b99aaf"));
        block.print();
